...
public class Question1 {
	...
	public static void main(String[] args) {
		...
		// Q4 変数名name String型で「山田太郎」を代入しテキストとともに出力
		String name = "山田太郎";
		System.out.println("こんにちは、" + name + "さん！");

		// Q5 変数名age int型で「25」を代入しテキストとともに出力
		int age = 25;
		System.out.println("年齢：" + age + "歳");

		/* Q6 変数名Num1 int型で「10」を代入
		      変数名Num2 int型で「5」を代入
		...
		*/
		...
		/* Q8 変数名price　double型で「99.99」を代入
		      priceをint型に変換し「99」で出力
		*/
		double price = 99.99;
		System.out.println((int) price);

		/* Q9 変数名numStr　String型で「123」を代入
